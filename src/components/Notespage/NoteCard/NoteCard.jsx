...
import { deleteNotes, updateNotes } from "../../../Redux/users/notes/note.actions";
import {
    Modal,
    ModalOverlay,
    ModalContent,
...
export default function NoteCard({ title, body, user, _id }) {
    ...
    return <Card backgroundImage={`url(${notebg})`}>
        <CardBody>
            <VStack>
                        ...
                        >
                            ...
                            <ModalContent>
                                ...
                                <ModalBody pb={6}>
                                    ...
                                    <Textarea mt={8} value={tempBody} placeholder={`Please enter description`} onChange={(e) => setBody(e.target.value)}></Textarea>
